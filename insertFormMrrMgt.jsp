...
//<![CDATA[
   ...
   function fnList(){
      document.location.href="/admin/mrr/"+fnSysMappingCode()+"selectPageListMrrMgt.do";
   }
   ...
   function fnInsert(){
     if($("[name=sj]").val() == ""){
      ...
      if(confirm("등록하시겠습니까?")){
         ...
         $("#aform").attr({action:"/admin/mrr/"+fnSysMappingCode()+"insertMrrMgt.do", method:'post'}).submit();
      }
   }
//]]>
</script>
                        ...
                        <table class="table text-nowrap inlineBlock">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td colspan="3">
                                    <input type="text" class="form-control" name="sj" maxlength="100" autocomplete='off'>
                                 </td>
                              </tr>
                              <tr>
                                 <th class="required_field">등록자 부서</th>
                                 <td>
                                     <input type="text" class="form-control" name="dept" maxlength="100" autocomplete='off'>
                                 </td>
                                 <th class="required_field">등록자</th>
                                 <td>
                                    <input type="text" class="form-control" name="rgst_no" maxlength="100" value = "${ss_user_nm}" autocomplete='off'>
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td class="datetimepicker-td">
                                    <div>
                                       <input type="text" class="form-control" name="rsdve_dt" autocomplete='off'>
                                    </div>
                                 </td>
                                 <th class="required_field">예약 시간</th>
                                 <td class="datetimepicker-td">
                                    <div class="d-flex">
                                       <input type="text" class="form-control" name="start_t" autocomplete='off'>
                                       <div class="text-center"> ~ </div>
                                       <input type="text" class="form-control" name="end_t" autocomplete='off'>
                              ...
                              <tr>
                                 <th>참여인원</th>
                                 <td colspan="3">
                                    <input type="text" class="form-control" name="partcptn_cnt" maxlength="100" autocomplete='off'>
                                 </td>
                              </tr>
                              <tr>
                                 <th>회의 내용</th>
                                 <td colspan="3">
                                    <textarea class="form-control" rows="10" id="cn" name="cn" placeholder="회의 내용"></textarea>
                                 </td>
                              </tr>
